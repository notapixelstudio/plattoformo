...
func _physics_process(delta):
	...
	apply_central_impulse(walk_speed*Vector2(int(Input.is_action_pressed('ui_right'))-int(Input.is_action_pressed('ui_left')),0))
	$Sprite.flip_h = bool(Input.is_action_pressed('ui_left'))
